...
import { Sparkles, Presentation, Shirt, Palette, Maximize, Music, Mic, KeyRound, CheckCircle2 } from 'lucide-react';

type Tab = 'create' | 'presentations' | 'merchandising' | 'editor' | 'upscale' | 'music' | 'voice';
